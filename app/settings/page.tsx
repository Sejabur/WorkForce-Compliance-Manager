...
export default function SettingsPage() {
  ...
  const handleSavePolicy = async (e: React.FormEvent) => {
    ...
    await savePolicyAsync(updatedPolicy);
  ...
  const handleResetPolicy = async () => {
    ...
    if (confirm("Reset policy rules to standard corporate default parameters?")) {
      await savePolicyAsync(DEFAULT_POLICY);
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {/* CARD 2: Security Settings with Passcode Visibility Toggle */}
          ...
          <div className="max-w-md space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-3.5 pr-10 py-2.5 text-sm rounded-xl skeuo-input bg-white text-brand-navy font-bold tracking-wider disabled:bg-slate-100"
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-brand-navy transition-colors p-1"
